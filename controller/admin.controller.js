...
const addVeterian = catchAsyncError(async (req, res, next) => {
  ...
  if (veterianExists) {
    ...
    signUpLink = `<p> <h3>Hello Veterinary! </h3>Welcome to our Team!! Here are your credentials<br> User email: ${addedVeterinary.email} <br> Password: ${defaultPassword}  <br>  <br>   </p> <a href="https://mpasystem.vercel.app/login">Sign in to continue</a>`;
